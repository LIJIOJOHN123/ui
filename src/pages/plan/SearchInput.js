...
function PlanSearchPopup({ setSearchQueries }) {
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Search Plan Details</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            {/* Explicit Inputs */}
            <InputGroup className="mb-3">
              <InputGroup.Text>Plan Name</InputGroup.Text>
              <Form.Control
                type="text"
...
export default PlanSearchPopup;
